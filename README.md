<p align="center">
  <img src="https://i.imgur.com/l49fYpH.jpg" width="500"/>
</p>

<h1 align="center">Aeternium Info Dok</h1>
<p align="center">
  𝙁𝙞𝙣𝙙𝙚 𝙙𝙚𝙞𝙣𝙚𝙣 𝙒𝙚𝙜 𝙞𝙣 𝙙𝙚𝙧 𝙒𝙚𝙡𝙩 𝙫𝙤𝙣 𝙋𝙖𝙡𝙬𝙤𝙧𝙡𝙙!
</p>
...
## 🛠️ Allgemeine QoL-Verbesserungen
- Kosten für Kondensatoren auf 3 / 6 / 9 / 12 angepasst
- Maximaler Stack häufig genutzter Materialien von 9.999 → 100.000 erhöht
...
- Arbeitsgeschwindigkeit pro Sekunde erhöht für:
    - Bewässerung
    - Pflanzen
    - Sammeln
    - Anzünden
...
- Überarbeitete Arbeitsprioritäten:
    - Kühlen 
    - Transportieren
- Minen & Holzfällen in Werkstätten werden gegenüber Naturressourcen priorisiert
-Angeln: 
    - Arbeitszeit stark reduziert
-Werkgeschwindigkeits-Möbel: 
    - Effekt von 20 % → 50 %
- Ranch-Pals droppen nun alle Items auf einmal
- Vixy droppt nur noch Pal-Sphären (mehr Vielfalt je Rang)
- Ölpumpen überall platzierbar (keine Standortbeschränkungen mehr)
- Erlaubt das Bauen schwebender Fundamente
- Erlaubt Bauen auf sehr steilem Gelände
- Erlaubt überlappende Strukturen
- Entfernt die maximale Bauhöhenbegrenzung
...
## 🧬 Zucht, IVs & Passives
- IV-Vererbung garantiert von einem Elternteil
    - 100 / 100 / 100 Eltern = 100 / 100 / 100 Nachwuchs
- Vererbungswahrscheinlichkeit für Passives:
1 / 2 / 3 / 4 Passives: 10 % / 20 % / 30 % / 40 %
- Regenbogen-Passives: Chance von 5 → 50
...
- Pro Statpunkt:
    ...
    - Traglast entfernt
    - Arbeitstempo +100
    - Stamina-Regeneration stark erhöht
    - HP-Regeneration leicht erhöht
    - Pal-Geschwindigkeit +~50 %
    - Spieler-Geschwindigkeit +~20 %
      
---

## 🐾 Alpha-, Lucky- & Partner-Anpassungen
- Alpha & Lucky Pals
    - Garantierte 100 / 100 / 100 IVs
    - Droppen Riesen-Seelen
- Partnerfähigkeiten mit Terrain-Bonus:
    - Jetzt +10 / 20 / 30 / 40 / 50 %
- Buffs:
Yakumo:
    - Sync-Chance 15 / 30 / 45 / 60 / 75
    - Braloha: Zuchtgeschwindigkeit 100–200 %
    - Lovander & Felbat: HP-Drain bis 10 %
- Neue / angepasste Arbeitsfähigkeiten:
    - Incineram / Vanwyrm: Feuer 2
    - Faleris: Feuer 4
    - Nitewing: Transport 2
    - Rushoar: Minen 2
    - Direhowl & Yakumo: verbesserte Sprünge
...
- Erhöhte Spawnraten: 
    ...
    - Implantate ~10%
	- Drop Tabelle --> [Drück mich](https://docs.google.com/spreadsheets/d/151qcZbbgpGMOUf9tLtzveymrU7SNJQjvF_A9i3zizXc/edit?usp=sharing)
- Handbücher:
    - Dungeons ~10%
    - Supply Drops ~100%
- Alpha-Bosse:
    - Legendäre Schemata ~10%
- Pal-Seelen:
    - 50 % Dropchance für alle Pals
    - Stärkere Pals = stärkere Seelen
- Menschen:
    - Droppen alle Schlüsseltypen
    - Mehr Geld & Bounty-Tokens
- Händler:
...
- Guild Chest: 300 Slots
    - Alle Lagerarten stark vergrößert (abhängig von Rang & Level)
    - Gilt nur für neue Gilden oder neue Spielstände ⚠️
